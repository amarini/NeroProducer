...

{
    ...
    *(evt -> metfilterNames) = iConfig.getParameter < std::vector<std::string> > ("metfilterNames");
    ...
    {
    jets -> qg_dR_tokens_i[Form("mult-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<int>>(edm::InputTag("QGVariables", Form("mult-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_i[Form("Gen-mult-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<int>>(edm::InputTag("QGVariables", Form("Gen-mult-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));

    jets -> qg_dR_tokens_f[Form("axis2-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("axis2-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_f[Form("Gen-axis2-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("Gen-axis2-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_f[Form("ptD-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("ptD-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_f[Form("Gen-ptD-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("Gen-ptD-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_f[Form("axis1-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("axis1-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
    jets -> qg_dR_tokens_f[Form("Gen-axis1-dR0p%.0f",dR*1000)] = mayConsume<edm::ValueMap<float>>(edm::InputTag("QGVariables", Form("Gen-axis1-dR-0p%.0f-pT-%.0f",dR*1000,float(500))));
