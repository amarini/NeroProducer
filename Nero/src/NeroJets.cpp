...
int NeroJets::analyze(const edm::Event& iEvent, const edm::EventSetup &iSetup){
    ...
    for( const auto& dR: dRToProduce){
        iEvent.getByToken( qg_dR_tokens_f[Form("axis2-dR0p%.0f",dR*1000)] , qg_handle_f[Form("axis2-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_f[Form("Gen-axis2-dR0p%.0f",dR*1000)] , qg_handle_f[Form("Gen-axis2-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_f[Form("axis1-dR0p%.0f",dR*1000)] , qg_handle_f[Form("axis1-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_f[Form("Gen-axis1-dR0p%.0f",dR*1000)] , qg_handle_f[Form("Gen-axis1-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_f[Form("ptD-dR0p%.0f",dR*1000)] , qg_handle_f[Form("ptD-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_f[Form("Gen-ptD-dR0p%.0f",dR*1000)] , qg_handle_f[Form("Gen-ptD-dR0p%.0f",dR*1000)]) ;

        iEvent.getByToken( qg_dR_tokens_i[Form("mult-dR0p%.0f",dR*1000)] , qg_handle_i[Form("mult-dR0p%.0f",dR*1000)]) ;
        iEvent.getByToken( qg_dR_tokens_i[Form("Gen-mult-dR0p%.0f",dR*1000)] , qg_handle_i[Form("Gen-mult-dR0p%.0f",dR*1000)]) ;
    }
    ...
    for (const pat::Jet& j : *handle)
    {
        ...
        for(const auto & dR : dRToProduce)
        {
            qglMult_dR[Form("0p%.0f",dR*1000)]	    ->push_back((*qg_handle_i[Form("mult-dR0p%.0f",dR*1000)])[jetRef]);
            qglPtD_dR[Form("0p%.0f",dR*1000)]	    ->push_back((*qg_handle_f[Form("ptD-dR0p%.0f",dR*1000)])[jetRef]);
            qglAxis2_dR[Form("0p%.0f",dR*1000)]	    ->push_back((*qg_handle_f[Form("axis2-dR0p%.0f",dR*1000)])[jetRef]);
            qglAxis1_dR[Form("0p%.0f",dR*1000)]	    ->push_back((*qg_handle_f[Form("axis1-dR0p%.0f",dR*1000)])[jetRef]);
        }
        ...
        if (not iEvent.isRealData())
        {
            ...
            if (matched){
                for(const auto & dR : dRToProduce)
                {
                    qglGenMult_dR[Form("0p%.0f",dR*1000)]	->push_back((*qg_handle_i[Form("Gen-mult-dR0p%.0f",dR*1000)])[genjetRef]);
                    qglGenPtD_dR[Form("0p%.0f",dR*1000)]	->push_back((*qg_handle_f[Form("Gen-ptD-dR0p%.0f",dR*1000)])[genjetRef]);
                    qglGenAxis2_dR[Form("0p%.0f",dR*1000)]	->push_back((*qg_handle_f[Form("Gen-axis2-dR0p%.0f",dR*1000)])[genjetRef]);
                    qglGenAxis1_dR[Form("0p%.0f",dR*1000)]	->push_back((*qg_handle_f[Form("Gen-axis1-dR0p%.0f",dR*1000)])[genjetRef]);
                }
            }else{
                for(const auto & dR : dRToProduce)
                {
                    qglGenMult_dR[Form("0p%.0f",dR*1000)]	->push_back(-999);
                    qglGenPtD_dR[Form("0p%.0f",dR*1000)]	->push_back(-999);
                    qglGenAxis2_dR[Form("0p%.0f",dR*1000)]	->push_back(-999);
                    qglGenAxis1_dR[Form("0p%.0f",dR*1000)]	->push_back(-999);
                }
            }
        }
